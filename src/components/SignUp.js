            ...
            <section className="h-screen flex justify-center bg-gray-200">
                <div className="flex justify-center items-center my-20 sm:my-0">
                    <div className="container max-w-md">
                        <form onSubmit={this.onSubmit} className="w-full p-10 shadow-md bg-white px-8 pt-6 pb-8 mb-4">
                            <div className="flex flex-wrap -mx-3 mb-6">
                                <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                <label className="block uppercase tracking-wide text-gray-600 text-xs font-bold mb-2" >
                                    Prénom
                                </label>
                                <input name="firstname" value={firstname} onChange={this.onChange} className="shadow appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Jean" />
                                </div>
                            ...
                            <div className="flex items-center justify-center">
                                    <button disabled={isInvalid} type="submit" className="transition ease-in-out duration-300 nav-links bg-teal-400 hover:bg-white border text-blue-800 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                        Créer mon compte
                                    </button>
                            </div>
                        </form>
